        ...
        return this.each(function() {
            ...
            if(rContent!='') {
	            ...
	            for( n=0; n< em.length; n++ ){
	            	var phrase = em[n].phrase;
			        var t = "<img alt='"+phrase.substring(1,phrase.length-1)+"' src='images/face/"+em[n].url+"' />";
			        phrase=new RegExp(phrase.replace("[","\\[").replace("]","\\]"),"g");
			        rContent = rContent.replace(phrase,t);
		        }
	        }
